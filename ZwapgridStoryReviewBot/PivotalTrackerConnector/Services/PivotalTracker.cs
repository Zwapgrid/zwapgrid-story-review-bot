...
using PivotalTrackerConnector.Enums;
...
namespace PivotalTrackerConnector.Services
{
    public class PivotalTracker
    {
        ...
        public PivotalTracker(string apiToken, int? projectId = null)
        {
            ...
            _httpService.SetupHttpClient(_apiToken);
        }
        ...
        public async Task<PivotalUser> AuthorizeAsync(string username, string password)
        {
            ...
            var authorisationResponse = await _httpService.AuthorizeAsync(username, password);
            var authUser = await HandleResponse<PivotalUser>(authorisationResponse);
        ...
        {
            var response =  await _httpService.GetAsync("projects");

            return await HandleResponse<List<PivotalProject>>(response);
        }
        ...
        public async Task<PivotalProject> GetCurrentProjectAsync(int? projectId = null)
        {
            ...
            var response = await _httpService.GetAsync(StringUtil.PivotalProjectsUrl(projectId ?? _projectId));
            return await HandleResponse<PivotalProject>(response);
        }
        #endregion
        ...
        public async Task<List<PivotalStory>> GetProjectStoriesAsync(int? projectId = null)
        {
            ...
            var response = await _httpService.GetAsync(StringUtil.PivotalStoriesUrl(properProjectId));

            return await HandleResponse<List<PivotalStory>>(response);
        }
        ...
        public async Task<PivotalSearchModel> GetMyWorkAsync(int? projectId = null, string queryValue = "")
        {
            ...
            var response = await _httpService.GetAsync(StringUtil.PivotalMyWorkQuery(properProjectId, queryValue));

            return await HandleResponse<PivotalSearchModel>(response);
        }
        ...
        {
            var properProjectId = GetProjectIdToUse(projectId);
            var response = await _httpService.GetAsync(StringUtil.PivotalBacklogQuery(properProjectId));
        ...
        {
            var properProjectId = GetProjectIdToUse(projectId);
            var response = await _httpService.GetAsync(StringUtil.PivotalIceboxQuery(properProjectId));
        ...
        public async Task<PivotalSearchModel> SearchByQueryAsync(int? projectId = null, string query = "")
        {
            ...
            var properProjectId = GetProjectIdToUse(projectId);
            var response = await _httpService.GetAsync(StringUtil.PivotalStorySearchUrl(properProjectId, query));
        ...
        public async Task<PivotalStory> CreateNewStoryAsync(int? projectId, string name, StoryType storyType, List<string> labels = null, string description = null)
        {
            ...
            var response = await _httpService.PostAsync(StringUtil.PivotalStoriesUrl(properProjectId), story);
        ...
        public async Task<PivotalStory> CreateNewStoryAsync(int? projectId, PivotalStory pivotalStory)
        {
            ...
            var response = await _httpService.PostAsync(StringUtil.PivotalStoriesUrl(properProjectId), pivotalStory);
        ...
        public async Task<List<PivotalTask>> GetTasksFromStoryAsnc(int? projectId, int storyId)
        {
            ...
            return await HandleResponse<List<PivotalTask>>(response);
        }
        ...
        public async Task<PivotalTask> CreateNewStoryTaskAsync(int? projectId, int storyId, PivotalTask pivotalTask)
        {
            ...
            return await HandleResponse<PivotalTask>(response);
        }
        ...
        public async Task<bool> DeleteStoryTaskAsync(int? projectId, int storyId, int taskId)
        {
            ...
            return await HandleResponseBoolean(response);
        }
        #endregion
        ...
        public async Task<List<PivotalComment>> GetCommentsAsync(int? projectId, int storyId, bool includeAttachments = false)
        {
            ...
            var response = await _httpService.GetAsync(StringUtil.PivotalCommentsUrl(properProjectId, storyId));

            return await HandleResponse<List<PivotalComment>>(response);
        }
        ...
        public async Task<PivotalComment> CreateNewCommentAsync(PivotalStory pivotalStory, string bodyText)
        {
            ...
            if (storyFromPivotal != null)
            {
                ...
                return await HandleResponse<PivotalComment>(response);
            }
        ...
        public async Task<PivotalComment> CreateNewCommentAsync(PivotalComment pivotalComment)
        {
            ...
            var response = await _httpService.PostAsync(StringUtil.PivotalCommentsUrl(pivotalComment.ProjectId, pivotalComment.StoryId), pivotalComment);
        ...
        public async Task<PivotalComment> CreateNewCommentAsync(int? projectId, int storyId, string bodyText)
        {
            ...
            var response = await _httpService.PostAsync(StringUtil.PivotalCommentsUrl(properProjectId, storyId), pivotalComment);
        ...
        public async Task<PivotalComment> CreateNewCommentAsync(int? projectId, int storyId, string bodyText, Stream fileData, bool closeFileDataStream = true)
        {
            ...
            using (var ms = new MemoryStream())
            {
                ...
                var fileStream = (FileStream)fileData;
                ...
                var uploadResponse = await _httpService.PostContentAsync(StringUtil.PivotalUploadsUrl(properProjectId), form);
                ...
                if (uploadResponse.IsSuccessStatusCode)
                {
                    ...
                    var uploadedFile = await Serialize<PivotalAttachment>(uploadResponse);
                    ...
                    var commentResponse = await _httpService.PostAsync($"projects/{projectId}/stories/{storyId}/comments", newComment);
                    if (commentResponse.IsSuccessStatusCode)
                    {
                        // Serialise response to object
                        var serializedComment = await Serialize<PivotalComment>(commentResponse);
                    ...
                    throw await ThrowException(commentResponse);
                }

                // Failure, throw generic exception with response
                throw await ThrowException(uploadResponse);
            }
        }
        ...
        public async Task<PivotalComment> UpdateCommentAsync(int? projectId, int storyId, PivotalComment comment)
        {
            ...
            var response = await _httpService.PutAsync(StringUtil.PivotalCommentsUrl(properProjectId, storyId, comment.Id), comment);
        ...
        private async Task<T> HandleResponse<T>(HttpResponseMessage responseMessage)
        {
            ...
            {
                // Success, return serialised response
                return await Serialize<T>(responseMessage);
            }

            // Failure, throw generic exception with response
            throw await ThrowException(responseMessage);
        }
        /// <summary>
        ...
        private async Task<bool> HandleResponseBoolean(HttpResponseMessage responseMessage)
        {
            if (responseMessage.IsSuccessStatusCode)
            {
        ...
        private async Task<PivotalHttpException> ThrowException(HttpResponseMessage response)
        {
